...
class NeoLanguageModelFeaturizer(DenseFeaturizer, GraphComponent):
    ...
    def __init__(
        ...
        super(NeoLanguageModelFeaturizer, self).__init__(
    ...
    def get_default_config() -> Dict[Text, Any]:
        """Returns NeoLanguageModelFeaturizer's default config."""
        return {
    ...
    ) -> NeoLanguageModelFeaturizer:
        """Creates a NeoLanguageModelFeaturizer.
